...
public class Service {
    ...
    public Service(AuthorDAOStrategy dao) {
        this.dao = dao;
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        Service service = new Service( new AuthorDAO(new  MySqlDbStrategy() ,"com.mysql.jdbc.Driver","jdbc:mysql://localhost:3306/book","root","DJ2015"));
